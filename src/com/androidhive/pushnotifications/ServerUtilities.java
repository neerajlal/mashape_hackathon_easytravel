...
public final class ServerUtilities {
     ...
     * @throws IOException propagated from POST.
     */
    private static void poster(String endpoint, Map<String, String> params) throws IOException {
    	
    	// Post Data
        List<NameValuePair> nameValuePair = new ArrayList<NameValuePair>();
        
        endpoint += "?name=" + params.get("name") + "&email=" + params.get("email") + "&regId=" + params.get("regId");
